...
$data = $db->query("select * from genshin_character NATURAL join genshin_entity where name = 'Diluc Ragnvindr'");
...
?>
    ...
    <div class="container rounded bg-white mt-5 mb-5">
        ...
        <h2 style="text-align: center; font-style: italic; font-family: 'Courier New', monospace; " class="center"><?php echo $data[0]['entity_id']?></h2>
